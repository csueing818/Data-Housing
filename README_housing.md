...
<body>
    ...
    <div class="container">
        <div class="portfolio-item">
            <h3>Project 1</h3>
            <p>Income and housing costs were compared across the cities in Texas. Based on the income-to-rent ratio,the location impacted housing affordability. High housing costs caused residents to seek housing in suburban areas based on the rental prices. Please click the link to view the data <a href="https://docs.google.com/spreadsheets/d/12gVLFEQVi7URMVn18D7pVvQJkQQniCOjRmKgkZ4ovdw/edit?usp=sharing"> Housing Data
            </a>
            </p>
        </div>
